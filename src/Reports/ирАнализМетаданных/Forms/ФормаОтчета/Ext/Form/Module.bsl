...
Процедура НастроитьКомпоновщик(ЗаполнитьНастройки = Истина)
	...
	Если ЗаполнитьНастройки Тогда
		...
		Если Не ирОбщий.ЛиКорневойОбщийТипМетаданныхЛкс(ТипОбъектов) Тогда 
...
Функция СписокВыбораТипаОбъекта()
	...
	Массив = ирКэш.ТипыМетаОбъектов();
	СписокВыбора = Новый СписокЗначений;
	Для Каждого ТипОбъектовЦикл Из Массив Цикл
		СписокВыбора.Добавить("ОбъектМетаданных" + ТипОбъектовЦикл.Единственное, ТипОбъектовЦикл.Единственное);
	КонецЦикла;
