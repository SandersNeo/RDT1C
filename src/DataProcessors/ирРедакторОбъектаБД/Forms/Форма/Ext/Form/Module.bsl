...
Перем мСтрокаПорядкаНайденныхСсылок;
Перем мБлокировкаОбъекта;
...
Функция ДобавитьСтрокуТаблицыРеквизиты(ЗначениеРеквизита, ИмяРеквизита, Представление = "", ОписаниеТипов = Неопределено, ТолькоПросмотр = Ложь, ДанныеИзБД = Истина, МетаРеквизит = Неопределено)
	...
	ИначеЕсли МетаРеквизит <> Неопределено Тогда
		#Если Сервер И Не Сервер Тогда
			МетаРеквизит = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.ПустаяСсылка(); //@skip-check unknown-method-property
		#КонецЕсли
...
Процедура НастроитьЭлементыФормы(ЭтаФорма)
	ЭлементыФормы.ДействияФормы.Кнопки.Удалить.Доступность = Ложь
	...
	ЭлементыФормы.ДействияФормы.Кнопки.ПометитьНаУдаление.Доступность = фОбъект.ЭтоСсылочныйОбъект и ЗначениеЗаполнено(фОбъект.ВыбОбъект) И фОбъект.мДоступноИзменение;
	ЭлементыФормы.ДействияФормы.Кнопки.Перечитать.Доступность = ЗначениеЗаполнено(ИмяОсновнойТаблицы) И Не фОбъект.ЭтоМетаСсылка;
	ЭлементыФормы.ДействияФормы.Кнопки.Провести.Доступность = фОбъект.ЭтоДокумент И ЗначениеЗаполнено(фОбъект.ВыбОбъект);
	ЭлементыФормы.ДействияФормы.Кнопки.СделатьНепроведённым.Доступность = фОбъект.ЭтоДокумент И ЗначениеЗаполнено(фОбъект.ВыбОбъект);
	ЭлементыФормы.ДействияФормы.Кнопки.РедакторИзмененийНаУзле.Доступность = фОбъект.ЭтоПланОбмена И ЗначениеЗаполнено(фОбъект.ВыбОбъект);
	//ЭлементыФормы.ДействияФормы.Кнопки.Записать.Текст = "Записать " + ЭлементыФормы.ПанельОсновная.ТекущаяСтраница.Заголовок;
	...
	КонецЕсли;
	ЭлементыФормы.ДействияФормы.Кнопки.Записать.Текст = ПодсказкаКнопки;
	ЭлементыФормы.ДействияФормы.Кнопки.Записать.Подсказка = ПодсказкаКнопки;
	ЭлементыФормы.ДействияФормы.Кнопки.Записать.Пояснение = ПодсказкаКнопки;
	...
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюТекущаяТаблица.Кнопки.ВТаблицу.Доступность = ЗначениеЗаполнено(ИмяОсновнойТаблицы) И АктивнаСтраницаИзменяемыхДанных;
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюТекущаяТаблица.Кнопки.ИзТаблицы.Доступность = ЗначениеЗаполнено(ИмяОсновнойТаблицы) И АктивнаСтраницаИзменяемыхДанных;
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюТекущаяТаблица.Кнопки.МенеджерТабличногоПоля.Доступность = ТекущееТабличноеПоле() <> Неопределено И ЭлементыФормы.ПанельОсновная.Доступность;
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюТекущаяТаблица.Кнопки.РедакторОбъектаБДЯчейки.Доступность = ТекущееТабличноеПоле() <> Неопределено И ЭлементыФормы.ПанельОсновная.Доступность;
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.ИзменитьИдентификатор.Доступность = фОбъект.ЭтоСсылочныйОбъект и ЗначениеЗаполнено(фОбъект.ВыбОбъект) И Не фОбъект.ЭтоМетаСсылка;
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.УдалитьСКонтролемСсылок.Доступность = фОбъект.ЭтоСсылочныйОбъект и ЗначениеЗаполнено(фОбъект.ВыбОбъект) И Не фОбъект.ЭтоМетаСсылка;
	...
	ЭлементыФормы.ДействияФормы.Кнопки.Записать.Доступность = Истина
		И фОбъект.мДоступноИзменение
		И (Ложь
			Или фОбъект.ЛиЧитатьПисатьДвижения
			Или ЭлементыФормы.ПанельОсновная.ТекущаяСтраница <> ЭлементыФормы.ПанельОсновная.Страницы.СтраницаСтраницыПанельДвижения);
	ЭлементыФормы.ДействияФормы.Кнопки.ЗаписатьИЗакрыть.Доступность = Истина
		И фОбъект.мДоступноИзменение
...
Процедура ПодготовитьСтраницыДвижений(Объект)
	...
	Если ЗначениеЗаполнено(КлючСтрокиСтраницы) Тогда
		ирКлиент.НайтиСтрокуТабличногоПоляЛкс(ЭтаФорма, ЭлементыФормы.СтраницыПанельДвижения, "Имя", КлючСтрокиСтраницы,,, Ложь);
	КонецЕсли;
КонецПроцедуры
...
Процедура ЗагрузитьТаблицыДвижений(Объект, ВосстанавливатьТекущуюСтроку = Истина)
	...
	МетаРегистры = ирОбщий.МетаданныеНаборовЗаписейПоРегистраторуЛкс(ОбъектМД, Истина, Истина);
	...
	Для Каждого МетаРегистр из МетаРегистры Цикл
...
Функция ПоместитьДанныеВТЧ(Объект, ИмяТЧ)
	...
	КонецЕсли;
	ирОбщий.ЗагрузитьВТаблицуЗначенийЛкс(тчНаФорме, тчОбъекта,,, Истина);
	Возврат тчНаФорме.Количество();
КонецФункции
...
Процедура ПеречитатьДанные(Знач СохранятьИдентификаторСсылки = Ложь, ТолькоМакет = Ложь, СсылкаИзменилась = Истина, Знач ЗапретитьЗаполнение = Ложь)
	...
	мБлокировкаОбъекта = Неопределено;
	ЭтаФорма.БлокироватьОбъект = Ложь;
...
Функция ПоместитьДанныеОбъектаВФорму(СтруктураОбъекта, ДанныеИзБД = Истина, СсылкаИзменилась = Истина)
	...
	Если СсылкаИзменилась Тогда
		...
		Для Каждого СтрокаСвязанныхДанных Из фОбъект.СвязиКолонок Цикл
	...
	КонецЕсли;
	Если фОбъект.ЭтоСсылочныйОбъект Тогда
		//! СтруктураОбъекта = 0 // см. ирОбщий.докОбъектБДПоКлючуСсылочный
		...
		Иначе
			...
			Для Каждого Свойство Из СписокСвойств Цикл // ПланВидовХарактеристикСсылка.ДополнительныеРеквизитыИСведения
		...
		КонецЕсли;
		КнопкаПометкиНаУдаление = ЭлементыФормы.ДействияФормы.Кнопки.ПометитьНаУдаление;
		Если фОбъект.ЭтоВнешнийОбъект Или фОбъект.ЭтоМетаСсылка Тогда
	...
	Иначе // Это набор записей
		//! СтруктураОбъекта = 0 // см. ирОбщий.докОбъектБДПоКлючуРегистр
...
Процедура ЗаполнитьСвязанныеДанные()
	СтараяСтрока = ЭлементыФормы.СвязиКолонок.ТекущаяСтрока;
	...
	КонецЕсли;
	ИзбранныеСвязи = фОбъект.СвязиКолонок.Выгрузить(Новый Структура("Избранное", Истина), "ПолноеИмяТаблицы, ИмяКолонки");
	СвязиКолонок.Очистить();
	Если ТипЗнч(фОбъект.ВыбОбъект) = Тип("Строка") Тогда
		Возврат;
	КонецЕсли;
	...
	Для Каждого ОписаниеТаблицы Из ТаблицаВсехТаблицБД Цикл
		...
		Для Каждого ПолеТаблицыБД Из ПоляТаблицыБД Цикл
			...
			Тогда
				СтрокаСвязи = фОбъект.СвязиКолонок.Добавить();
	...
	Если СтарыйКлюч <> Неопределено Тогда
		НайденныеСтроки = фОбъект.СвязиКолонок.НайтиСтроки(СтарыйКлюч);
		Если НайденныеСтроки.Количество() > 0 Тогда
			ЭлементыФормы.СвязиКолонок.ТекущаяСтрока = ирОбщий.ИдентификаторСтрокиТабличногоПоляЛкс(НайденныеСтроки[0]);
		КонецЕсли;
	КонецЕсли;
	Если ВыполнитьНачальноеЗаполнениеИзбранного Тогда
		СохранитьИзбранныеСвязиКолонок();
	КонецЕсли;
...
Процедура ПриОткрытии()
	...
	мКнопкаИдентификаторы = ЭлементыФормы.ДействияФормы.Кнопки.ПодменюТекущаяТаблица.Кнопки.Идентификаторы;
...
Процедура ЗагрузитьОбъектПоКлючу(Знач КлючИлиОбъект) Экспорт
	...
	Если ТипЗнч(КлючИлиОбъект) = Тип("Структура") И КлючИлиОбъект.Свойство("ПолноеИмяТаблицы") Тогда
		...
		Если ирОбщий.ЛиТипВложеннойТаблицыБДЛкс(ирОбщий.ТипТаблицыБДЛкс(НовоеИмяОсновнойТаблицы)) Тогда
			НовоеИмяОсновнойТаблицы = ирОбщий.ТекстБезПоследнегоФрагментаЛкс(НовоеИмяОсновнойТаблицы);
...
Функция ПолучитьИзмененныйОбъект(выхВерсияДанныхИзменена = Ложь, выхВсегоСтрокТЧ = 0)
	выхВсегоСтрокТЧ = 0;
	Если фОбъект.ЭтоМетаСсылка Тогда
	...
	Иначе
		...
		Если фОбъект.ЭтоСсылочныйОбъект Тогда
			...
			Для Каждого КлючИЗначение из СтруктураТЧ Цикл
				выхВсегоСтрокТЧ = выхВсегоСтрокТЧ + ПоместитьДанныеВТЧ(СтруктураОбъекта.Данные, КлючИЗначение.Ключ);
			КонецЦикла;
...
Функция ЗаписатьОбъект(Знач РежимЗаписи, ОбратимаяЗапись = Ложь)
	...
	ВсегоСтрокТЧ = 0;
	СтруктураОбъекта = ПолучитьИзмененныйОбъект(ВерсияДанныхИзменена, ВсегоСтрокТЧ);
	Если Истина
		//И ирКэш.ЛиПортативныйРежимЛкс()
		И ирКэш.ПараметрыЗаписиОбъектовЛкс().ОбъектыНаСервере
		И ВсегоСтрокТЧ > 20000
	Тогда
		Ответ = Вопрос("Большой объект может долго записываться в этом инструменте.
				|Для ускорения рекомендуется изменять его в варианте поставки ""Расширение"" через инструмент ""Подбор и обработка объектов БД"".
	...
	Для Каждого Сообщение Из Сообщения Цикл
		...
		Если ЗначениеЗаполнено(ИмяПоля) Тогда
			...
			Если фОбъект.ЭтоНаборЗаписей Тогда
				...
				ИмяТЧ = ТабличноеПоле.Данные;
				ИндексСтроки = Число(ирОбщий.ТекстМеждуМаркерамиЛкс(Сообщение.Текст, "Номер строки: ", ")")) - 1;
			КонецЕсли;
	...
	Иначе
		...
		Попытка
			...
			Если Истина
				...
				И фОбъект.ЛиЧитатьПисатьДвижения
				И Не ЗначениеЗаполнено(РежимЗаписи)
				И ЗначениеЗаполнено(НоваяСсылка)
			Тогда
		...
		Если Не ОбратимаяЗапись Тогда
			...
			Иначе
				Если ОткрылиТранзакцию Тогда
					ОтменитьТранзакцию();
					ирОбщий.СообщитьЛкс("--Отменена транзакция");
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
Процедура ОбъектСделатьНепроведённым(Кнопка)
	Ответ = Вопрос("Вы действительно хотите отменить проведение документа "+Строка(фОбъект.ВыбОбъект)+" ?", РежимДиалогаВопрос.ДаНет, 30, КодВозвратаДиалога.Нет, "Отменить проведение документа?");
	Если Ответ <> КодВозвратаДиалога.Да Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПанельОбъектаПриСменеСтраницы(Знач Элемент = Неопределено, Знач ТекущаяСтраница = Неопределено)
	...
	ИначеЕсли Страницы[ТекущаяСтраница] = Страницы.СтраницаСсылкиНаОбъект Тогда
		...
		КонецЕсли;
	ИначеЕсли Страницы[ТекущаяСтраница] = Страницы.СтраницаСвязи Тогда
		ЗагрузитьИзбранныеСвязанныеКолонкиБД();
		ЗагрузитьИзбранныеСвязиКТаблицеБД();
		Если Истина
			И СвязиКолонок.НайтиСтроки(Новый Структура("КоличествоСсылающихся", "?")).Количество() > 0
			И ЗначениеЗаполнено(ВыбОбъект)
			И (Ложь
				//Или СвязиКолонок.НайтиСтроки(Новый Структура("Избранное", Ложь)).Количество() = 0
...
Процедура РеквизитыТаблицаПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	// Для ускорения
	//КнопкаИдентификаторы = ЭлементыФормы.ДействияФормы.Кнопки.ПодменюТекущаяТаблица.Кнопки.Идентификаторы;
...
Процедура ПриАктивизацииСтрокиСтраницыДвижений(СброситьОтборПросмотра = Истина)
	...
	Если ЭлементыФормы.ПанельДвижения.Видимость Тогда
		...
		ЭлементыФормы.КоманднаяПанельНабораДвижений.Кнопки.ОтображатьОстатки.Доступность = Ложь
			Или ирОбщий.ЛиКорневойТипПоследовательностиЛкс(ирОбщий.ТипТаблицыБДЛкс(ИмяТаблицыБДРегистра))
			Или (Истина
...
Процедура ПриАктивизацииСтрокиСтраницыТаблиц(Знач ТабличноеПоле, Знач СброситьОтборПросмотра)
	ирКлиент.ТабличноеПолеСОтборомПросмотраУстановитьДанныеЛкс(ЭтаФорма, ТабличноеПоле, СброситьОтборПросмотра, Истина);
...
Процедура НастроитьКолонкиТабличногоПоляДвиженийИлиТЧ(Знач ТабличноеПолеНабораДвиженийИлиТЧ)
	...
	КонецЕсли;
	КолонкаНомерСтроки = ТабличноеПолеНабораДвиженийИлиТЧ.Колонки.Найти(ирОбщий.ИмяКолонкиНомерСтрокиЛкс());
	Если КолонкаНомерСтроки = Неопределено Тогда
		КолонкаНомерСтроки = ТабличноеПолеНабораДвиженийИлиТЧ.Колонки.Вставить(0);
		КолонкаНомерСтроки.Имя = ирОбщий.ИмяКолонкиНомерСтрокиЛкс();
	КонецЕсли;
	...
	ТабличноеПолеНабораДвиженийИлиТЧ.УстановитьДействие("Выбор", ЭлементыФормы.НаборЗаписей.ПолучитьДействие("Выбор"));
...
Процедура ОбновитьПометкиДереваУзлов()
	...
	Если Не ТаблицаИзмененийНедоступна Тогда
		...
		Для Каждого СтрокаТаблицыУзлов Из ТаблицаУзлов.НайтиСтроки(Новый Структура("НайденВДереве", Ложь)) Цикл
			СтрокаПланаОбмена = ИзмененияНаУзлах.Строки.Найти(СтрокаТаблицыУзлов.Узел.Метаданные().Имя, "ИмяПланаОбмена");
...
Процедура ПоискВОбъектеВыбор(Элемент = Неопределено, ВыбраннаяСтрока = Неопределено, Колонка = Неопределено, СтандартнаяОбработка = Неопределено)
	...
	Если Истина
		И фОбъект.ЭтоСсылочныйОбъект
		И Не ЗначениеЗаполнено(ВыбраннаяСтрока.ТаблицаОбъекта)
	Тогда
...
Процедура СвязанныеДанныеОбновитьКоличество(Кнопка = Неопределено)
	Если фОбъект.СвязиКолонок.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
	...
	СтрокиКолонокДляОбновления = фОбъект.СвязиКолонок;
...
Процедура ОбновитьКоличествоЗавершение(СостояниеЗадания = Неопределено, РезультатЗадания = Неопределено) Экспорт
	...
	Тогда
		...
		КонецЕсли;
		ЭлементыФормы.СвязиКолонок.ОбновитьСтроки(); // Если наложен отбор по КоличествоСсылающихся, то могут остаться пустые строки
	КонецЕсли;
КонецПроцедуры
...
Процедура СвязанныеДанныеТолькоНепустыеПриИзменении(ЭтаФорма)
	ирОбщий.УстановитьЭлементОтбораЛкс(ЭлементыФормы.СвязиКолонок.ОтборСтрок.Непустая, , Истина,, ТолькоНепустые);
	ирОбщий.УстановитьЭлементОтбораЛкс(ЭлементыФормы.СвязиКТаблицеБД.ОтборСтрок.Непустая, , Истина,, ТолькоНепустые);
КонецПроцедуры

Процедура ОбновитьОтборСвязанныхДанных(ТекстИмениТаблицы = Неопределено, ТекстИмениКолонки = Неопределено)
	ТабличноеПоле = ЭлементыФормы.СвязиКолонок;
...
Процедура НайтиТекущуюСтрокуВДинамическомСписке(Знач ИспользоватьДинамическийСписокИР, Знач ОтбиратьПоСтроке = Ложь)
	КлючОбъекта = КлючОбъекта();
	Если фОбъект.ЭтоКонстанта Тогда
...
Процедура СвязанныеДанныеПриАктивизацииСтроки(Элемент = Неопределено)
	Элемент = ЭлементыФормы.СвязиКолонок;
	Если Элемент.ТекущаяСтрока = Неопределено Тогда
		Если Элемент.Значение.Количество() Тогда
			Элемент.ТекущаяСтрока = Элемент.Значение[0];
		Иначе
			Возврат;
		КонецЕсли;
	КонецЕсли;
...
Процедура КоманднаяПанельСтрокиТаблицыБДРедактировать(Кнопка)
	ирКлиент.ОткрытьТекущуюСтрокуТабличногоПоляТаблицыБДВРедактореОбъектаБДЛкс(ЭлементыФормы.СтрокиТаблицыБД, ПолноеИмяСвязаннойТаблицыБД,,,,, Ложь,,,, ЭтаФорма);
КонецПроцедуры
...
Процедура ИмяОсновнойТаблицыПриИзменении(Элемент = Неопределено, Знач ЗапретитьЗаполнение = Неопределено)
	...
	мФормаУпрДляПодключаемыхКоманд = ирКлиент.ДобавитьКнопкиКомандБСПЛкс(ЭлементыФормы.ДействияФормы, ИмяОсновнойТаблицы);
	ОбновитьДеревоУзлов();
	Если Ложь
	...
	Иначе
		...
		ЭлементыФормы.КоманднаяПанельНабораЗаписей.Кнопки.ОтображатьОстатки.Доступность = Ложь
			Или ирОбщий.ЛиКорневойТипПоследовательностиЛкс(ирОбщий.ТипТаблицыБДЛкс(ИмяОсновнойТаблицы))
			Или (Истина
	...
	ЭлементыФормы.ПанельОсновная.Страницы.СтраницаСвязи.Видимость = фОбъект.ЭтоСсылочныйОбъект;
	ЭлементыФормы.ПанельОсновная.Страницы.СтраницаСсылкиНаОбъект.Видимость = фОбъект.ЭтоСсылочныйОбъект;
	ЭлементыФормы.ДействияФормы.Кнопки.Новый.Доступность = фОбъект.ЭтоСсылочныйОбъект И фОбъект.мДоступноИзменение;
	ЭлементыФормы.ДействияФормы.Кнопки.НоваяГруппа.Доступность = ирОбщий.ЛиМетаданныеОбъектаСГруппамиЛкс(ОбъектМД);
	ЭлементыФормы.ДействияФормы.Кнопки.Скопировать.Доступность = фОбъект.ЭтоСсылочныйОбъект И фОбъект.мДоступноИзменение;
	ЭлементыФормы.ДействияФормы.Кнопки.ДобавитьВИзбранное.Доступность = фОбъект.ЭтоСсылочныйОбъект;
	ЭлементыФормы.ДействияФормы.Кнопки.НайтиВДинамическомСписке.Доступность = Не фОбъект.ЭтоКонстанта И ЗначениеЗаполнено(ИмяОсновнойТаблицы);
	ЭлементыФормы.ДействияФормы.Кнопки.ОсновнаяФорма.Кнопки.ОткрытьОсновнуюФормуИзмененногоОбъекта.Доступность = фОбъект.ЭтоСсылочныйОбъект;
	ЭлементыФормы.ДействияФормы.Кнопки.ПоказатьРазличияБД.Доступность = фОбъект.мДоступноИзменение;
	ЭлементыФормы.ДействияФормы.Кнопки.НайтиВСписке.Доступность = ЗначениеЗаполнено(ИмяОсновнойТаблицы);
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.Исследовать.Доступность = ЗначениеЗаполнено(ИмяОсновнойТаблицы);
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.ВыгрузитьВXML.Доступность = Не фОбъект.ЭтоВнешнийОбъект И Не фОбъект.ЭтоМетаСсылка И ЗначениеЗаполнено(ИмяОсновнойТаблицы);
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.ЗагрузитьИзXML.Доступность = Не фОбъект.ЭтоВнешнийОбъект И Не фОбъект.ЭтоМетаСсылка И ЗначениеЗаполнено(ИмяОсновнойТаблицы);
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.КонсольОбработки.Доступность = ЗначениеЗаполнено(ИмяОсновнойТаблицы);
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.ЗаполнитьНепустыми.Доступность = ЗначениеЗаполнено(ИмяОсновнойТаблицы);
	ЭлементыФормы.ДействияФормы.Кнопки.ПодменюПрочее.Кнопки.ЖурналРегистрации.Доступность = фОбъект.ЭтоСсылочныйОбъект Или фОбъект.ЭтоКонстанта;
	СвязиКолонок.Очистить();
	СвязиКТаблицеБД.Очистить();
...
Процедура ЗагрузитьИзбранныеСвязанныеКолонкиБД()
	Если СвязиКолонок.Количество() = 0 Тогда
		ИзбранныеСвязи = ирОбщий.ВосстановитьЗначениеЛкс(КлючХраненияИзбранныхСвязейКолонок());
		Если ИзбранныеСвязи <> Неопределено Тогда
			Для Каждого ИзбраннаяСвязь Из ИзбранныеСвязи Цикл
				СтрокаСвязаннойКолонки = СвязиКолонок.Добавить();
...
Функция КлючХраненияИзбранныхСвязейКолонок() Экспорт
	Результат = "ирРедакторОбъектаБД." + ИмяОсновнойТаблицы + ".ИзбранныеСвязи";
	Возврат Результат;
КонецФункции

Процедура ОбновитьКнопкиСвязанныхКолонокБД()
	НоваяДоступность = СвязиКолонок.Количество() > 0;
...
Процедура НаборЗаписейПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	...
	Если Истина
		И ДанныеСтроки.Владелец().Колонки.Найти("Активность") <> Неопределено
	...
	Если Истина
		И КолонкаТПКартинка <> Неопределено 
		И ДанныеСтроки.Владелец().Колонки.Найти("ВидДвижения") <> Неопределено 
	Тогда
		ВидДвижения = ДанныеСтроки.ВидДвижения;
		Если Ложь
			Или ВидДвижения = ВидДвиженияНакопления.Приход
			Или ВидДвижения = ВидДвиженияБухгалтерии.Дебет
		Тогда
			ИндексКартинки = 0;
		Иначе
			ИндексКартинки = 1;
...
Процедура ЗаблокироватьДляРедактирования() Экспорт
	Если Не ЗначениеЗаполнено(ВыбОбъект) Или Не Автоблокировка Тогда
		Возврат;
	КонецЕсли;
	ЭтаФорма.БлокироватьОбъект = Истина;
	БлокироватьОбъектПриИзменении();
КонецПроцедуры
...
Процедура НайденныеСсылкиВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	...
	Если ВыбраннаяСтрока <> Неопределено Тогда
		ирКлиент.ОткрытьСсылкуИзРезультатаПоискаСсылокЛкс(ТекущиеДанные);
	КонецЕсли;
КонецПроцедуры
...
Процедура ДополнительныеПоляПрочитатьПоля(Кнопка = Неопределено)
	Кнопка = ЭлементыФормы.КоманднаяПанельДопПоля.Кнопки.СсылкиПрочитатьДопПоля;
	...
	ЛиАсинхронно = Ложь;
	мСтрокаПорядкаНайденныхСсылок = ирКлиент.ПрочитатьДопПоляСсылающихсяОбъектовЛкс(ЭлементыФормы.НайденныеСсылки, КомпоновщикДопПолей,,, ЭтаФорма, Кнопка, "ПослеЧтенияДопПолей", ЛиАсинхронно);
	Если Не ЛиАсинхронно Тогда
		СортироватьНайденные();
	КонецЕсли;
КонецПроцедуры

Процедура ПослеЧтенияДопПолей(СостояниеЗадания = Неопределено, РезультатЗадания = Неопределено) Экспорт
	Если РезультатЗадания = Неопределено Тогда
		Возврат;
	КонецЕсли;
	ТаблицаДанных = РезультатЗадания.ТаблицаДанных; // см. СсылкиНаОбъект
	Для Каждого СтрокаРезультата Из ТаблицаДанных Цикл
		//Если СтрокаРезультата.Данные = Неопределено Тогда
		//	Продолжить;
		//КонецЕсли;
		СтрокаСсылки = СсылкиНаОбъект[ТаблицаДанных.Индекс(СтрокаРезультата)];
		Если СтрокаСсылки.Данные <> СтрокаРезультата.Данные Тогда
			// Пользователь отсортировал таблицу ссылающихся объектов
			Продолжить;
		КонецЕсли;
		ЗаполнитьЗначенияСвойств(СтрокаСсылки, СтрокаРезультата);
	КонецЦикла;
	СортироватьНайденные();
КонецПроцедуры

Процедура СортироватьНайденные() Экспорт
	Если Не ЗначениеЗаполнено(мСтрокаПорядкаНайденныхСсылок) Тогда
		Возврат;
	КонецЕсли;
	СсылкиНаОбъект.Сортировать(мСтрокаПорядкаНайденныхСсылок);
	мСтрокаПорядкаНайденныхСсылок = "";
КонецПроцедуры
...
Процедура ОсновныеДействияФормыОткрытьОбъектМетаданных(Кнопка = Неопределено)
	ПолеВводаИмениТаблицыОткрытие(ЭлементыФормы.ИмяОсновнойТаблицы);
КонецПроцедуры
...
Процедура ПолеВводаИмениТаблицыОткрытие(Элемент, СтандартнаяОбработка = Истина)
	СтандартнаяОбработка = Ложь;
	Если ЗначениеЗаполнено(Элемент.Значение) Тогда
		ирКлиент.ОткрытьОбъектМетаданныхЛкс(Элемент.Значение);
	КонецЕсли;
КонецПроцедуры
...
Процедура СохранитьИзбранныеСвязиКолонок()
	ИзбранныеСвязи = СвязиКолонок.ВыгрузитьКолонки("ИмяКолонки, ПолноеИмяТаблицы");
	Если СвязиКолонок.Найти(Истина, "Избранное") = Неопределено Тогда
		// Если пометок "Избранное" нет, то поставим у первой строки, чтобы намекнуть пользователю что полезного тут нет
		СвязиКолонок[0].Избранное = Истина;
	КонецЕсли;
	Для Каждого СтрокаИзбранного Из СвязиКолонок.НайтиСтроки(Новый Структура("Избранное", Истина)) Цикл
		ЗаполнитьЗначенияСвойств(ИзбранныеСвязи.Добавить(), СтрокаИзбранного);
	КонецЦикла;
	ирОбщий.СохранитьЗначениеЛкс(КлючХраненияИзбранныхСвязейКолонок(), ИзбранныеСвязи);
КонецПроцедуры
...
Процедура ОткрытьДинамичекийСписокСвязаннойТаблицы(ИспользоватьДинамическийСписокИР = Неопределено, СвязанныйДинамическийСписокИР = Ложь)
	ВыбраннаяСтрока = ирКлиент.ДанныеСтрокиТабличногоПоляЛкс(ЭлементыФормы.СвязиКолонок);
	Если ВыбраннаяСтрока = Неопределено Тогда
		Возврат;
	КонецЕсли;
...
Процедура КП_СвязанныеКолонкиУстановитьПометки(Кнопка)
	ирКлиент.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.СвязиКолонок,, Истина);
КонецПроцедуры

Процедура КП_СвязанныеКолонкиСнятьПометки(Кнопка)
	ирКлиент.ИзменитьПометкиВыделенныхИлиОтобранныхСтрокЛкс(ЭтаФорма, ЭлементыФормы.СвязиКолонок,, Ложь);
КонецПроцедуры
...
Процедура НадписьОбщиеПараметрыЗаписиНажатие(Элемент)
	ирКлиент.ОткрытьОбщиеПараметрыЗаписиЛкс(Элемент);
КонецПроцедуры
...
Процедура КП_СвязанныеКолонкиТолькоИзбранное(Кнопка = Неопределено)
	...
	ПринудительноОбновить = СвязиКолонок.Найти(Истина, "Избранное") = Неопределено; // Если пометки сняты у всех строк, то очень вероятно что это пользователь сделал случайно. Поэтому и в этом случае перезаполняем.
...
Процедура ВерсииОбъектаПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки) Экспорт
	ирКлиент.ТабличноеПолеПриВыводеСтрокиЛкс(ЭтаФорма, Элемент, ОформлениеСтроки, ДанныеСтроки);
	ирКлиент.ЗаполнитьИзмененныеПоляВСтрокеВерсииДанныхЛкс(ДанныеСтроки, КлючОбъекта());
КонецПроцедуры
...
Процедура КП_СвязанныеКолонкиОткрытьОбъектМетаданных(Кнопка)
	ВыбраннаяСтрока = ЭлементыФормы.СвязиКолонок.ТекущаяСтрока;
	Если ВыбраннаяСтрока = Неопределено Тогда
		Возврат;
	КонецЕсли;
...
Функция КлючСсылающегосяОбъекта(Знач ТекущаяСтрока)
	Возврат ирКлиент.КлючОбъектаНайденнойСсылкиЛкс(ТекущаяСтрока);
КонецФункции
...
Процедура НаборЗаписейПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока И Не Копирование Тогда
		...
		КонецЕсли;
	КонецЕсли;
	ирКлиент.ТабличноеПолеСОтборомПросмотраПриНачалеРедактированияЛкс(ЭтаФорма, ТабличноеПоле, НоваяСтрока, Копирование);
КонецПроцедуры
...
Процедура КоманднаяПанельНабораЗаписейОтображатьОстатки(Кнопка = Неопределено) Экспорт
...
Процедура ОбновитьКолонкиОстатков(ТабличноеПолеРегистра = Неопределено, НоваяПометка = Неопределено)
	Кнопка = Неопределено; // КнопкаКоманднойПанели
	ОбъектМД = КонтекстСтрокиРегистра(ТабличноеПолеРегистра, Кнопка);
	Если ОбъектМД = Неопределено Или Не Кнопка.Доступность Тогда
		Возврат;
	КонецЕсли;
...
//.
// Параметры:
//   ТабличноеПолеРегистра - РасширениеТабличногоПоляТаблицыЗначений, Неопределено -
//   Кнопка - КнопкаКоманднойПанели, КнопкаКоманднойПанели -
Функция КонтекстСтрокиРегистра(ТабличноеПолеРегистра = Неопределено, Кнопка = Неопределено, ИмяТаблицыБДРегистра = "") Экспорт
	#Если Сервер И Не Сервер Тогда
	...
	Если ЭтоСсылочныйОбъект Тогда
		...
		КонецЕсли;
		Если Ложь
			Или Не ирОбщий.ЛиКорневойТипРегистраБДЛкс(ИмяТаблицыБДТабличногоПоля(ТабличноеПолеРегистра))
			Или ТекущаяСтрока <> Неопределено И ТабличноеПолеРегистра.Имя <> ТекущаяСтрока.ИмяСтраницы
		Тогда
...
Процедура НаборЗаписейПриПолученииДанных(ТабличноеПолеРегистра, ОформленияСтрок)
	...
	ОбъектМД = КонтекстСтрокиРегистра(ТабличноеПолеРегистра, Кнопка, ИмяТаблицыБДРегистра);
...
Процедура ПоказатьСвязанныеКолонкиБД() Экспорт
	...
	ПанельОсновная.ТекущаяСтраница = ПанельОсновная.Страницы.СтраницаСвязи;
	ПанельСвязи = ЭлементыФормы.ПанельСвязи;
	ПанельСвязи.ТекущаяСтраница = ПанельСвязи.Страницы.СтраницаСвязанныеДанные;
	Если СвязиКолонок.Количество() = 0 Тогда
...
Процедура КП_СвязанныеКолонкиКолонкаБД(Кнопка)
	ТекущаяСтрока = ЭлементыФормы.СвязиКолонок.ТекущаяСтрока;
	Если ТекущаяСтрока = Неопределено Тогда
		Возврат;
	КонецЕсли;
...
Процедура НаборЗаписейВыбор(Элемент = Неопределено, ВыбраннаяСтрока = Неопределено, Колонка = Неопределено, СтандартнаяОбработка = Истина)
	ТабличноеПоле = ТекущееТабличноеПоле();
	Если Колонка = Неопределено Тогда
		Колонка = ТабличноеПоле.Колонки[ирОбщий.ИмяКолонкиНомерСтрокиЛкс()];
	КонецЕсли;
	Если Не Колонка.ТолькоПросмотр Тогда
		Возврат;
	КонецЕсли;
	ВыбраннаяСтрока = ТабличноеПоле.ТекущаяСтрока;
	СтандартнаяОбработка = Ложь;
	ИмяТаблицыБДРегистра = "";
	ОбъектМД = КонтекстСтрокиРегистра(,, ИмяТаблицыБДРегистра);
	Если ОбъектМД = Неопределено Тогда
		Возврат;
	КонецЕсли;
	ЗначенияИзмерений = Новый Структура;
	Для Каждого ОбъектМетаданныхИзмерение Из ОбъектМД.Измерения Цикл
		Если Истина
			И ирОбщий.ЛиКорневойТипРегистраБухгалтерииЛкс(ИмяТаблицыБДРегистра)
			И Не ОбъектМетаданныхИзмерение.Балансовый
		Тогда
			Продолжить;
		КонецЕсли;
		ЗначенияИзмерений.Вставить(ОбъектМетаданныхИзмерение.Имя, ВыбраннаяСтрока[ОбъектМетаданныхИзмерение.Имя]);
	КонецЦикла;
	Если ирОбщий.СтрКончаетсяНаЛкс(Колонка.Имя, "Остаток",, Истина) Тогда
		Форма = ирКлиент.ПолучитьФормуЛкс("Обработка.ирРедакторОстатков.Форма",,, ОбъектМД.ПолноеИмя());
		Форма.ПараметрОтбор = ЗначенияИзмерений;
		Форма.Открыть();
	Иначе
		СтруктураКлюча = ирОбщий.СтруктураКлючаТаблицыБДЛкс(ИмяТаблицыБДРегистра,,, Ложь);
		ЗаполнитьКлючСтрокиТаблицыЗначений(СтруктураКлюча, ВыбраннаяСтрока);
		Если фОбъект.ЭтоСсылочныйОбъект И СтруктураКлюча.Свойство("Регистратор") Тогда
			СтруктураКлюча.Регистратор = ВыбОбъект;
		КонецЕсли;
		Если ирОбщий.ПервыйФрагментЛкс(ИмяТаблицыБДРегистра) = "Последовательность" Тогда
			КлючСтроки = Новый Структура("ПолноеИмяТаблицы, Структура", ИмяТаблицыБДРегистра, СтруктураКлюча);
		Иначе
			КлючСтроки = ирОбщий.ПолучитьМенеджерЛкс(ИмяТаблицыБДРегистра).СоздатьКлючЗаписи(СтруктураКлюча);
		КонецЕсли;
		ирКлиент.ОткрытьФормуСпискаЛкс(ИмяТаблицыБДРегистра,, Истина,,,, КлючСтроки,, ЗначенияИзмерений, Колонка.Данные);
	КонецЕсли;
КонецПроцедуры

Процедура КоманднаяПанельНабораЗаписейНайтиВДинамическомСписке(Кнопка)
	НаборЗаписейВыбор();
КонецПроцедуры

Процедура БлокироватьОбъектПриИзменении(Элемент = Неопределено)
	Если БлокироватьОбъект И ЗначениеЗаполнено(фОбъект.ВыбОбъект) Тогда
		мБлокировкаОбъекта = фОбъект.ВыбОбъект.ПолучитьФорму(,, Новый УникальныйИдентификатор);
		Попытка
			Если ТипЗнч(мБлокировкаОбъекта) = ирОбщий.ТипУправляемаяФормаЛкс() Тогда
				мБлокировкаОбъекта.ЗаблокироватьДанныеФормыДляРедактирования();
			Иначе
				мБлокировкаОбъекта.Заблокировать();
			КонецЕсли;
		Исключение
...
Процедура СтрокаПоискаПриИзменении(Элемент = Неопределено, АктивизироватьПервуюСтроку = Неопределено, Текст = Неопределено)
	...
	КонецЕсли;
	Если Текст = Неопределено Тогда
		Текст = РеквизитыТаблицаСтрокаПоиска;
	КонецЕсли;
	ирКлиент.ПрименитьСтрокуПоискаКТабличномуПолюЛкс(ЭтаФорма, ЭлементыФормы.РеквизитыТаблица, Текст, "ИмяРеквизита, ПредставлениеРеквизита, Подсказка", АктивизироватьПервуюСтроку <> Ложь);
КонецПроцедуры
...
Процедура НайтиСвязиДоТаблицыПриИзменении(Элемент)
	ирКлиент.ПолеВводаСИсториейВыбора_ПриИзмененииЛкс(Элемент, ЭтаФорма);
	СвязиКТаблицеБД.Очистить();
	ЗагрузитьИзбранныеСвязиКТаблицеБД();
КонецПроцедуры

Процедура ИмяТаблицыДляПоискаПутейДоНачалоВыбора(Элемент, СтандартнаяОбработка)
	ирКлиент.ОбъектМетаданныхНачалоВыбораЛкс(Элемент, ПараметрыВыбораОбъектаМетаданных(), СтандартнаяОбработка);
КонецПроцедуры

Процедура ИмяТаблицыДляПоискаПутейДоОкончаниеВводаТекста(Элемент, Текст, Значение, СтандартнаяОбработка)
	ирКлиент.ОбъектМетаданныхОкончаниеВводаТекстаЛкс(Элемент, ПараметрыВыбораОбъектаМетаданных(), Текст, Значение, СтандартнаяОбработка);
КонецПроцедуры

Функция ПараметрыВыбораТаблицыПутейДо()
	Возврат ирКлиент.ПараметрыВыбораОбъектаМетаданныхЛкс(Истина,,,,,,,,,, Истина);
КонецФункции

Процедура КП_ПутиКТаблицеБДНайтиПутиТаблицыБД(Кнопка)
	Если ПустаяСтрока(ИмяТаблицыДляСвязей) Тогда
		ЭтаФорма.ТекущийЭлемент = ЭлементыФормы.ИмяТаблицыДляСвязей;
		ирОбщий.СообщитьЛкс("Не указано имя таблицы для поиска путей до.");
		Возврат;
	КонецЕсли;
	СтараяСтрока = ЭлементыФормы.СвязиКТаблицеБД.ТекущаяСтрока;
	Если СтараяСтрока <> Неопределено Тогда
		СтарыйКлюч = Новый Структура("ПутьКОсновномуОбъекту, ПутьКСвязанномуОбъекту");
		ЗаполнитьЗначенияСвойств(СтарыйКлюч, СтараяСтрока);
	КонецЕсли;
	ИзбранныеСвязи = СвязиКТаблицеБД.Выгрузить(Новый Структура("Избранное", Истина));
	СвязиКТаблицеБД.Очистить();
	ЭлементыФормы.СвязиКТаблицеБД.ОбновитьСтроки();
	ТаблицаВсехТаблицБД = ирКэш.ТаблицаВсехТаблицБДЛкс();
	ТипСсылкиНачала = ТипЗнч(ВыбОбъект);
	Если ЛиСсылочнаяТаблицаДляСвязи() Тогда
		ТипСсылкиКонца = Тип(ирОбщий.ИмяТипаИзПолногоИмениМДЛкс(ИмяТаблицыДляСвязей));
	Иначе
		ТипСсылкиКонца = Неопределено;
	КонецЕсли;
	ИменаСвойствТаблицы = "ПутьСтрокой, ПройденныеТаблицы";
	КэшПутейКНачалу = Новый Соответствие; // - Ключ - имя таблицы из которой описан путь к ТипСсылки
	КэшПутейККонцу = Новый Соответствие; // - Ключ - имя таблицы из которой описан путь к ТипСсылки
	РазделительПутиСвязи = РазделительПутиСвязи();
	СостояниеОбновленияФормы = Неопределено;
	Для ДлинаЦикл = 1 По МаксДлинаСвязи Цикл
		Индикатор = ирОбщий.ПолучитьИндикаторПроцессаЛкс(ТаблицаВсехТаблицБД.Количество(), "Поиск связей " + ДлинаЦикл);
		Для Каждого ОписаниеТаблицы Из ТаблицаВсехТаблицБД Цикл
			ирОбщий.ОбработатьИндикаторЛкс(Индикатор);
			Если Ложь
				Или ирОбщий.ЛиКорневойТипКритерияОтбораЛкс(ОписаниеТаблицы.Тип)
				Или ирОбщий.ЛиКорневойТипКонстантыЛкс(ОписаниеТаблицы.Тип)
				Или ирОбщий.ЛиКорневойТипЖурналаДокументовЛкс(ОписаниеТаблицы.Тип)
				Или ОписаниеТаблицы.Тип = "Изменения"
				Или ОписаниеТаблицы.Тип = "ВиртуальнаяТаблица"
			Тогда
				Продолжить;
			КонецЕсли;
			ПутьТекущейТаблицыКНачалу = КэшПутейКНачалу[ОписаниеТаблицы.ПолноеИмя];
			ПутьТекущейТаблицыККонцу = КэшПутейККонцу[ОписаниеТаблицы.ПолноеИмя];
			Если Истина
				И ПутьТекущейТаблицыКНачалу <> Неопределено
				И ПутьТекущейТаблицыККонцу <> Неопределено
			Тогда
				Длина = СтрЧислоВхождений(ПутьТекущейТаблицыКНачалу.ПутьСтрокой + РазделительПутиСвязи + ПутьТекущейТаблицыККонцу.ПутьСтрокой, РазделительПутиСвязи) + 1;
				Если Истина
					//И Длина <= МаксДлинаСвязи
					И Длина = ДлинаЦикл // Чтобы сразу отсортировано все было по длине
					И ирОбщий.ПервыйФрагментЛкс(ПутьТекущейТаблицыККонцу.ПутьСтрокой, РазделительПутиСвязи) <> ирОбщий.ПервыйФрагментЛкс(ПутьТекущейТаблицыКНачалу.ПутьСтрокой, РазделительПутиСвязи)
					И ПутьТекущейТаблицыККонцу.ПутьСтрокой <> ""
					И ПутьТекущейТаблицыКНачалу.ПутьСтрокой <> ""
				Тогда
					ОтборСвязей = НовыйОтборСвязейКТаблице();
					ОтборСвязей.ПутьКОсновномуОбъекту = ПутьТекущейТаблицыКНачалу.ПутьСтрокой;
					ОтборСвязей.ПутьКСвязанномуОбъекту = ПутьТекущейТаблицыККонцу.ПутьСтрокой;
					ОтборСвязей.Соединение = ОписаниеТаблицы.ПолноеИмя;
					НайденныеСтроки = СвязиКТаблицеБД.НайтиСтроки(ОтборСвязей);
					Если НайденныеСтроки.Количество() = 0 Тогда
						СтрокаСвязи = СвязиКТаблицеБД.Добавить();
						ЗаполнитьЗначенияСвойств(СтрокаСвязи, ОтборСвязей);
						СтрокаСвязи.Длина = Длина;
						СтрокаСвязи.Избранное = ИзбранныеСвязи.НайтиСтроки(ОтборСвязей).Количество() > 0;
						ирКлиент.ПроверитьПервоеОбновлениеТабличногоПоляЛкс(ЭлементыФормы.СвязиКТаблицеБД, СостояниеОбновленияФормы,, 1);
					КонецЕсли;
				КонецЕсли;
				Продолжить;
			КонецЕсли;
			ПоляТаблицыБД = ирКэш.ПоляТаблицыБДЛкс(ОписаниеТаблицы.ПолноеИмя, ИмяСиноним);
			Если ПоляТаблицыБД = Неопределено Тогда
				Продолжить;
			КонецЕсли;
			ТипСсылкиТаблицыЦикл = Неопределено;
			ЛиТипВложеннойТаблицыБД = ирОбщий.ЛиТипВложеннойТаблицыБДЛкс(ОписаниеТаблицы.Тип);
			ЛиКорневойТипСсылки = ирОбщий.ЛиКорневойТипСсылкиЛкс(ОписаниеТаблицы.Тип);
			Если Ложь
				Или ЛиКорневойТипСсылки
				//Или ЛиТипВложеннойТаблицыБД
			Тогда
				ТипСсылкиТаблицыЦикл = ПоляТаблицыБД.Найти("Ссылка", "Имя").ТипЗначения.Типы()[0];
			КонецЕсли;
			Для Каждого ПолеТаблицыБД Из ПоляТаблицыБД Цикл
				Если Ложь
					Или (Истина
						И ЛиКорневойТипСсылки
						И (Ложь
							Или ПолеТаблицыБД.Имя = "Ссылка"
							Или ПолеТаблицыБД.Имя = "Родитель"
							Или ПолеТаблицыБД.Имя = "ПометкаУдаления"))
					Или (Истина
						И ЛиТипВложеннойТаблицыБД
						И (Ложь
							Или ПолеТаблицыБД.Имя = "Ссылка"
							Или ПолеТаблицыБД.Имя = "НомерСтроки"))
				Тогда
					Продолжить;
				КонецЕсли;
				Типы = ПолеТаблицыБД.ТипЗначения.Типы();
				Если Истина
					И МаксЧислоТиповВКолонке
					И Типы.Количество() > МаксЧислоТиповВКолонке
				Тогда
					Продолжить;
				КонецЕсли;
				Для Каждого ТипКолонки Из Типы Цикл
					ИмяПоляБД = ПолеТаблицыБД.Имя;
					Если ТипКолонки = Тип("ТаблицаЗначений") Тогда
						ИмяТипаКолонки = ОписаниеТаблицы.ПолноеИмя + "." + ИмяПоляБД;
						ИмяПоляБД = "[" + ИмяТипаКолонки + "]";
					Иначе
						МетаданныеТипа = Метаданные.НайтиПоТипу(ТипКолонки);
						Если МетаданныеТипа = Неопределено Тогда
							Продолжить;
						КонецЕсли;
						ИмяТипаКолонки = ирКэш.ИмяТаблицыИзМетаданныхЛкс(МетаданныеТипа.ПолноеИмя());
					КонецЕсли;
					ОбработатьШагСвязи(ОписаниеТаблицы.ПолноеИмя, ИменаСвойствТаблицы, КэшПутейКНачалу, ПутьТекущейТаблицыКНачалу, ТипСсылкиТаблицыЦикл, ТипСсылкиНачала, ИмяТаблицыДляСвязей, ДлинаЦикл, ИмяТипаКолонки,
						ИмяПоляБД, СвязиКТаблицеБД, ИзбранныеСвязи, ТипКолонки, СостояниеОбновленияФормы, "ПутьКОсновномуОбъекту");
					Если ТипСсылкиКонца <> Неопределено Тогда
						ОбработатьШагСвязи(ОписаниеТаблицы.ПолноеИмя, ИменаСвойствТаблицы, КэшПутейККонцу, ПутьТекущейТаблицыККонцу, ТипСсылкиТаблицыЦикл, ТипСсылкиКонца, ИмяОсновнойТаблицы, ДлинаЦикл, ИмяТипаКолонки,
							ИмяПоляБД, СвязиКТаблицеБД, ИзбранныеСвязи, ТипКолонки, СостояниеОбновленияФормы, "ПутьКСвязанномуОбъекту");
					КонецЕсли;
				КонецЦикла;
			КонецЦикла;
		КонецЦикла;
	...
	КонецЦикла;
	Если СтарыйКлюч <> Неопределено Тогда
		НайденныеСтроки = СвязиКТаблицеБД.НайтиСтроки(СтарыйКлюч);
		Если НайденныеСтроки.Количество() > 0 Тогда
			ЭлементыФормы.СвязиКТаблицеБД.ТекущаяСтрока = ирОбщий.ИдентификаторСтрокиТабличногоПоляЛкс(НайденныеСтроки[0]);
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры

Функция ЛиСсылочнаяТаблицаДляСвязи() Экспорт
	Результат = ирОбщий.ЛиКорневойТипСсылочногоОбъектаБДЛкс(ирОбщий.ПервыйФрагментЛкс(ИмяТаблицыДляСвязей));
	Возврат Результат;
КонецФункции

Процедура ОбработатьШагСвязи(ИмяРодительскойТаблицы, ИменаСвойствТаблицы, КэшПутей, ТекущаяТаблица, ТипСсылкиТаблицыЦикл, ТипСсылкиК, ИмяТаблицыОт, ДлинаГлобальная, ИмяТипаКолонки, ИмяПоляБД, СвязиКТаблицеБД, 
		ИзбранныеСвязи, ТипКолонки, СостояниеОбновленияФормы, ИмяКолонкиПути)
	РазделительПутиСвязи = РазделительПутиСвязи();
	ПутьСтрокой = ИмяПоляБД;
	Если ТипКолонки <> ТипСсылкиК Тогда
		ПутьПред = КэшПутей[ИмяТипаКолонки];
		Если ПутьПред = Неопределено Тогда
			Возврат;
		КонецЕсли;
		ПутьСтрокой = ПутьСтрокой + ?(ПутьПред.ПутьСтрокой="", "", РазделительПутиСвязи + ПутьПред.ПутьСтрокой);
	КонецЕсли;
	РазделительПутиСвязи = РазделительПутиСвязи();
	ДлинаНовогоПути = СтрЧислоВхождений(ПутьСтрокой, РазделительПутиСвязи) + 1;
	Если Ложь
		Или ДлинаНовогоПути > ДлинаГлобальная 
		Или ТипКолонки = ТипСсылкиК И ДлинаНовогоПути < ДлинаГлобальная
	Тогда
		Возврат;
	КонецЕсли;
	Если ТекущаяТаблица = Неопределено Тогда
		ТекущаяТаблица = Новый Структура(ИменаСвойствТаблицы, ПутьСтрокой, Новый Массив);
		КэшПутей[ИмяРодительскойТаблицы] = ТекущаяТаблица;
		ДлинаСтарогоПути = 1000;
	Иначе
		ДлинаСтарогоПути = СтрЧислоВхождений(ТекущаяТаблица.ПутьСтрокой, РазделительПутиСвязи) + 1;
	КонецЕсли;
	Если ДлинаСтарогоПути > ДлинаНовогоПути Тогда
		ТекущаяТаблица.ПутьСтрокой = ПутьСтрокой;
		//ТекущаяТаблица.ПройденныеТаблицы.Добавить(ИмяРодительскойТаблицы);
		ДлинаСтарогоПути = ДлинаНовогоПути;
	КонецЕсли;
	Если Истина
		И ИмяРодительскойТаблицы = ИмяТаблицыОт 
		И ДлинаНовогоПути = ДлинаГлобальная
	Тогда
		СтрокаСвязи = СвязиКТаблицеБД.Добавить();
		СтрокаСвязи[ИмяКолонкиПути] = ПутьСтрокой;
		СтрокаСвязи.Длина = ДлинаНовогоПути;
		ОтборСвязей = НовыйОтборСвязейКТаблице();
		ЗаполнитьЗначенияСвойств(ОтборСвязей, СтрокаСвязи);
		СтрокаСвязи.Избранное = ИзбранныеСвязи.НайтиСтроки(ОтборСвязей).Количество() > 0;
		ирКлиент.ПроверитьПервоеОбновлениеТабличногоПоляЛкс(ЭлементыФормы.СвязиКТаблицеБД, СостояниеОбновленияФормы,, 1);
	КонецЕсли;
КонецПроцедуры

Функция НовыйОтборСвязейКТаблице() Экспорт
	ОтборПутей = Новый Структура("ПутьКОсновномуОбъекту, ПутьКСвязанномуОбъекту, Соединение");
	Возврат ОтборПутей;
КонецФункции

Функция РазделительПутиСвязи() Экспорт
	Возврат ",";
КонецФункции

Процедура КП_СвязиКТаблицеБДОткрытьЗапрос(Кнопка = Неопределено)
	СтрокаСвязи = ЭлементыФормы.СвязиКТаблицеБД.ТекущиеДанные;
	Если СтрокаСвязи = Неопределено Тогда
		Возврат;
	КонецЕсли;
	Запрос = СоздатьЗапросСвязиДляТаблицы(СтрокаСвязи);
	ирОбщий.ОтладитьЛкс(Запрос);
КонецПроцедуры

//.
// Параметры:
//   СтрокаСвязи - ОбработкаТабличнаяЧастьСтрока.ирРедакторОбъектаБД.СвязиКТаблицеБД -
// Возвращаемое значение:
//   Запрос -
Функция СоздатьЗапросСвязиДляТаблицы(Знач СтрокаСвязи = Неопределено, Знач ТолькоКоличество = Ложь) Экспорт
	Если СтрокаСвязи = Неопределено Тогда
		СтрокаСвязи = ЭлементыФормы.СвязиКТаблицеБД.ТекущиеДанные;
	КонецЕсли;
	Запрос = Новый Запрос;
	Если ТолькоКоличество Тогда
		ТекстВЫБРАТЬ = "ВЫБРАТЬ Количество(РАЗЛИЧНЫЕ ";
	Иначе
		ТекстВЫБРАТЬ = "ВЫБРАТЬ РАЗЛИЧНЫЕ(";
	КонецЕсли;
	Если СтрокаСвязи.ПутьКСвязанномуОбъекту = "" Тогда
		ЧастьЗапроса = ПостроитьЧастьЗапросаИзПутиСвязи(ИмяТаблицыДляСвязей, СтрокаСвязи.ПутьКОсновномуОбъекту, "Т");
		Если ЛиСсылочнаяТаблицаДляСвязи() Тогда
			Запрос.Текст = ТекстВЫБРАТЬ + "Т.Ссылка)
				|ИЗ
				|	" + ЧастьЗапроса.ТекстИз + "
				|ГДЕ
				|	" + ЧастьЗапроса.ПоследнийПуть + " = &Ссылка";
		Иначе
			Если ТолькоКоличество Тогда
				ТекстВЫБРАТЬ = "ВЫБРАТЬ Количество(*)";
			Иначе
			...
			Запрос.Текст = ТекстВЫБРАТЬ + "
				...
				|	" + ЧастьЗапроса.ПоследнийПуть + " = &Ссылка";
		КонецЕсли;
	ИначеЕсли СтрокаСвязи.ПутьКОсновномуОбъекту = "" Тогда
		ЧастьЗапроса = ПостроитьЧастьЗапросаИзПутиСвязи(ИмяОсновнойТаблицы, СтрокаСвязи.ПутьКСвязанномуОбъекту, "Т");
		Запрос.Текст = ТекстВЫБРАТЬ + ЧастьЗапроса.ПоследнийПуть + ") КАК Ссылка
			|ИЗ
			|	" + ЧастьЗапроса.ТекстИз + "
			|ГДЕ
			|	Т.Ссылка = &Ссылка
			|	И НЕ " + ЧастьЗапроса.ПоследнийПуть + " ЕСТЬ NULL";
	Иначе
		ЧастьЗапросаВходящая = ПостроитьЧастьЗапросаИзПутиСвязи(СтрокаСвязи.Соединение, СтрокаСвязи.ПутьКОсновномуОбъекту, "Т");
		ЧастьЗапросаИсходящая = ПостроитьЧастьЗапросаИзПутиСвязи(СтрокаСвязи.Соединение, СтрокаСвязи.ПутьКСвязанномуОбъекту, "Т");
		ТекстИз = СтрокаСвязи.Соединение + " КАК Т";
		Если ЧастьЗапросаВходящая.ТекстИз <> СтрокаСвязи.Соединение + " КАК Т" Тогда
			ТекстИз = ТекстИз + "
				|" + Сред(ЧастьЗапросаВходящая.ТекстИз, СтрДлина(СтрокаСвязи.Соединение + " КАК Т") + 1);
		КонецЕсли;
		Если ЧастьЗапросаИсходящая.ТекстИз <> СтрокаСвязи.Соединение + " КАК Т" Тогда
			ТекстИз = ТекстИз + "
				|" + Сред(ЧастьЗапросаИсходящая.ТекстИз, СтрДлина(СтрокаСвязи.Соединение + " КАК Т") + 1);
		КонецЕсли;
		Запрос.Текст = ТекстВЫБРАТЬ + ЧастьЗапросаИсходящая.ПоследнийПуть + ") КАК Ссылка
			|ИЗ
			|	" + ТекстИз + "
			|ГДЕ
			|	" + ЧастьЗапросаВходящая.ПоследнийПуть + " = &Ссылка
			|	И НЕ " + ЧастьЗапросаИсходящая.ПоследнийПуть + " ЕСТЬ NULL";
	КонецЕсли;
	Запрос.УстановитьПараметр("Ссылка", ВыбОбъект);
	Возврат Запрос;
КонецФункции

Функция РазобратьПутьСТЧ(Путь)
	Результат = Новый Массив;
	Фрагменты = ирОбщий.СтрРазделитьЛкс(Путь, РазделительПутиСвязи());
	Для Каждого Фрагмент Из Фрагменты Цикл
		Если Лев(Фрагмент, 1) = "[" Тогда
			Структура = Новый Структура("Тип, Имя", "ТабличнаяЧасть", ирОбщий.ТекстБезКрайнихСимволовЛкс(Фрагмент));
		Иначе
			Структура = Новый Структура("Тип, Имя", "Поле", Фрагмент);
		КонецЕсли;
...
Функция ПостроитьЧастьЗапросаИзПутиСвязи(ИмяОсновнойТаблицы, ПутьСтрокой, ПсевдонимОсновнойТаблицы = "Т")
	РазобранныйПуть = РазобратьПутьСТЧ(ПутьСтрокой);
	ТекстИз = ИмяОсновнойТаблицы + " КАК " + ПсевдонимОсновнойТаблицы;
	ПредыдущийПуть = ПсевдонимОсновнойТаблицы;
	НомерТЧ = 1;
	Для каждого ЭлементПути Из РазобранныйПуть Цикл
		Если ЭлементПути.Тип = "ТабличнаяЧасть" Тогда
			ПсевдонимТЧ = ирОбщий.ПоследнийФрагментЛкс(ЭлементПути.Имя) + "Т";
			ТекстИз = ТекстИз + "
				|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ " + ЭлементПути.Имя + " КАК " + ПсевдонимТЧ + "
				|	ПО " + ПредыдущийПуть + ".Ссылка = " + ПсевдонимТЧ + ".Ссылка";
			ПредыдущийПуть = ПсевдонимТЧ;
		ИначеЕсли ЭлементПути.Тип = "Поле" Тогда
			ПредыдущийПуть = ПредыдущийПуть + "." + ЭлементПути.Имя;
		КонецЕсли;
	КонецЦикла;
	Возврат Новый Структура("ТекстИз, ПоследнийПуть", ТекстИз, ПредыдущийПуть);
КонецФункции

Процедура СвязиКТаблицеБДПриАктивизацииСтроки(Элемент = Неопределено)
	Элемент = ЭлементыФормы.СвязиКТаблицеБД;
	Если Элемент.ТекущаяСтрока = Неопределено Тогда 
		Если Элемент.Значение.Количество() Тогда
			Элемент.ТекущаяСтрока = Элемент.Значение[0];
		Иначе
	...
	КонецЕсли;
	ирКлиент.ТабличноеПолеПриАктивизацииСтрокиЛкс(ЭтаФорма, Элемент);
	фОбъект.ПолноеИмяСвязаннойТаблицыБД = ИмяТаблицыДляСвязей;
	Запрос = СоздатьЗапросСвязиДляТаблицы();
	Попытка
	...
	Исключение
		...
		Возврат;
	КонецПопытки;
	ирКлиент.ЗагрузитьВыборкуВТабличноеПолеПервуюПорциюЛкс(ЭтаФорма, РезультатСтрокиТаблицы, мВыборкаРезультатаСтрокиТаблицы, ЭлементыФормы.КоманднаяПанельСтрокиТаблицыБД);
	ЭлементыФормы.СтрокиТаблицыБД.СоздатьКолонки();
	ирОбщий.НастроитьДобавленныеКолонкиТабличногоПоляЛкс(ЭлементыФормы.СтрокиТаблицыБД,,,, Истина);
	СтрокаСвязи = Элемент.ТекущаяСтрока;
	СтрокаСвязи.КоличествоОтобрано = СтрокиТаблицыБД.Количество();
	СтрокаСвязи.Непустая = СтрокиТаблицыБД.Количество() > 0;
КонецПроцедуры

Процедура СвязиКТаблицеБДПриВыводеСтроки(Элемент, ОформлениеСтроки, ДанныеСтроки)
	ирКлиент.ТабличноеПолеПриВыводеСтрокиЛкс(ЭтаФорма, Элемент, ОформлениеСтроки, ДанныеСтроки);
КонецПроцедуры

Процедура СвязиКТаблицеБДВыбор(Элемент, ВыбраннаяСтрока, Колонка, СтандартнаяОбработка)
	Если Элемент.Колонки.Соединение = Колонка Тогда
		ирКлиент.ОткрытьОбъектМетаданныхЛкс(ВыбраннаяСтрока.Соединение);
	Иначе
		КП_СвязиКТаблицеБДОткрытьЗапрос();
	КонецЕсли;
КонецПроцедуры

Процедура СвязиКТаблицеБДПриИзмененииФлажка(Элемент, Колонка)
	ирКлиент.ТабличноеПолеПриИзмененииФлажкаЛкс(ЭтаФорма, Элемент, Колонка);
КонецПроцедуры

Процедура КП_СвязиКТаблицеБДОбновитьКоличество(Кнопка)
	Индикатор = ирОбщий.ПолучитьИндикаторПроцессаЛкс(СвязиКТаблицеБД.Количество());
	Для Каждого СтрокаСвязи Из СвязиКТаблицеБД Цикл
		ирОбщий.ОбработатьИндикаторЛкс(Индикатор);
		Запрос = СоздатьЗапросСвязиДляТаблицы(СтрокаСвязи, Истина);
		СтрокаСвязи.КоличествоОтобрано = Запрос.Выполнить().Выгрузить()[0][0];
		СтрокаСвязи.Непустая = СтрокаСвязи.КоличествоОтобрано > 0;
	КонецЦикла;
	ирОбщий.ОсвободитьИндикаторПроцессаЛкс();
	ЭлементыФормы.СвязиКТаблицеБД.ОбновитьСтроки(); // Если наложен отбор по КоличествоСсылающихся, то могут остаться пустые строки
КонецПроцедуры

Процедура ПанельСвязиПриСменеСтраницы(Элемент = Неопределено, ТекущаяСтраница = Неопределено)
	СтрокиТаблицыБД.Очистить();
	Если ЭлементыФормы.ПанельСвязи.ТекущаяСтраница = ЭлементыФормы.ПанельСвязи.Страницы.СтраницаСвязанныеДанные Тогда
		СвязанныеДанныеПриАктивизацииСтроки();
	Иначе
		СвязиКТаблицеБДПриАктивизацииСтроки();
	КонецЕсли;
КонецПроцедуры

Процедура СохранитьИзбранныеСвязиКТаблицеБД()
	ИзбранныеСвязи = СвязиКТаблицеБД.ВыгрузитьКолонки("ПутьКОсновномуОбъекту, ПутьКСвязанномуОбъекту, Соединение");
	Для Каждого СтрокаИзбранного Из СвязиКТаблицеБД.НайтиСтроки(Новый Структура("Избранное", Истина)) Цикл
		ЗаполнитьЗначенияСвойств(ИзбранныеСвязи.Добавить(), СтрокаИзбранного);
	КонецЦикла;
	ирОбщий.СохранитьЗначениеЛкс(КлючХраненияИзбранныхСвязейКТаблицеБД(), ИзбранныеСвязи);
КонецПроцедуры 

Процедура ЗагрузитьИзбранныеСвязиКТаблицеБД()
	Если СвязиКТаблицеБД.Количество() > 0 Тогда
		Возврат;
	КонецЕсли;
	ИзбранныеСвязи = ирОбщий.ВосстановитьЗначениеЛкс(КлючХраненияИзбранныхСвязейКТаблицеБД());
	Если ИзбранныеСвязи <> Неопределено Тогда
		Для Каждого ИзбраннаяСвязь Из ИзбранныеСвязи Цикл
			СтрокаСвязи = СвязиКТаблицеБД.Добавить();
			ЗаполнитьЗначенияСвойств(СтрокаСвязи, ИзбраннаяСвязь);
			СтрокаСвязи.Избранное = Истина;
			СтрокаСвязи.КоличествоОтобрано = "?";
		КонецЦикла;
		СвязиКТаблицеБДПриАктивизацииСтроки();
	КонецЕсли;
КонецПроцедуры

Функция КлючХраненияИзбранныхСвязейКТаблицеБД() Экспорт
	Результат = "ирРедакторОбъектаБД[" + ИмяОсновнойТаблицы + "->" + ИмяТаблицыДляСвязей + "].ИзбранныеСвязиКТаблицеБД";
	Возврат Результат;
КонецФункции

Процедура СвязиКТаблицеБДИзбранноеПриИзменении(Элемент)
	СохранитьИзбранныеСвязиКТаблицеБД();
КонецПроцедуры
...
ирОбщий.ОчиститьПодчиненныеЭлементыФормыЛкс(ЭлементыФормы.ПанельДвижения);
фОбъект.ВыбОбъект = "";
фОбъект.МаксДлинаСвязи = 5;
фОбъект.МаксЧислоТиповВКолонке = 5;
...
мПодменюТекущаяТаблица = ЭлементыФормы.ДействияФормы.Кнопки.ПодменюТекущаяТаблица.Кнопки;
фОбъект.Автоблокировка = Истина;
