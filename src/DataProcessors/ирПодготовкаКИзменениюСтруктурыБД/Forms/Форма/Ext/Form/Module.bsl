...
Процедура ОбновитьДоступность()
	Если ИзменяемыеИзмерения.Количество() = 0 И УдаляемыеТипы.Типы().Количество() = 0 Тогда
		ЭлементыФормы.ДействияФормы.Кнопки.ЗаполнитьУсекаемыеТипы.КнопкаПоУмолчанию = Истина;
	ИначеЕсли ПроблемныеРегистры.Количество() = 0 И ПроблемныеПланыВидовХарактеристик.Количество() = 0 Тогда 
		ЭлементыФормы.ДействияФормы.Кнопки.Проверить.КнопкаПоУмолчанию = Истина;
	Иначе 
		ЭлементыФормы.ДействияФормы.Кнопки.Автокоррекция.КнопкаПоУмолчанию = Истина;
	КонецЕсли;
КонецПроцедуры
