...
Функция ИмяМодуляИзИмениФайлаГитаЛкс(Знач ВнутреннееИмяФайлаГита) Экспорт
	...
	Фрагменты = ирОбщий.СтрРазделитьЛкс(ирОбщий.СтрокаБезПоследнегоФрагментаЛкс(ВнутреннееИмяФайлаГита), "/");
...
Процедура ОткрытьОбъектМетаданныхПоИмениМодуляЛкс(Знач ИмяМодуляСжатое) Экспорт 
	ИмяОбъектаМодуля = ирОбщий.СтрокаБезПоследнегоФрагментаЛкс(ИмяМодуляСжатое);
